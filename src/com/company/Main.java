...
public class Main {
    ...
    //My solution
    public String stringBitsMyLogic(String str) {
        String newString = "";

        //loop increments i by 2
    ...
    //My solution
    public String stringSplosionMyLogic(String str) {
        String result = "";
    ...
    //My version of solution
    public int arrayCount9MyLogic(int[] nums) {
        int count = 0;
     ...
     * if one of the first 4 elements in the array is a 9. The array length may be less than 4.
     */
     ...
     * the sequence of numbers 1, 2, 3 appears in the array somewhere.
     */
